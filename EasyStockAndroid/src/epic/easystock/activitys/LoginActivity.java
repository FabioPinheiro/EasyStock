...
import epic.easystock.R.string;
...
public class LoginActivity extends Activity {
	...
	public class UserLoginTask extends AsyncTask<String, Void, Boolean> {
		...
		protected Boolean doInBackground(String... emailAccounts) {
			...
			if (!AppConstants
					.checkGooglePlayServicesAvailable(LoginActivity.this)) {
				return false;
			}
			...
			try {
				...
				GoogleAccountCredential credential = GoogleAccountCredential
						.usingAudience(LoginActivity.this,
		...
		protected void onPostExecute(Boolean success) {
			TextView emailAddressTV = (TextView) LoginActivity.this
					.findViewById(R.id.email);
			if (success) {
				// Authorization check successful, set internal variable.
				mEmail = emailAddressTV.getText().toString();
			} else {
