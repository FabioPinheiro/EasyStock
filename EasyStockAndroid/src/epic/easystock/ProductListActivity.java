...
public class ProductListActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * findViewById(R.id.itemName)) .getText().toString();
		 * item.setName(name);
		 * 
	...
	public class EndpointsTask extends AsyncTask<Context, Integer, Long> {
		protected Long doInBackground(Context... contexts) {
			...
			try {
				...
				String name = "Batatas";/*((EditText) findViewById(R.id.itemName))
						.getText().toString();*/
				item.setName(name);

				String description = "uns legumes bueda bons que veem da terra!";/*((EditText) findViewById(R.id.descriptionText))
						.getText().toString();*/
